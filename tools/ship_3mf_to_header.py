...
def main():
    ...
    w("// flat. The battery plugin will later override the indicator colours")
    w("// from charge state.")
    ...
    w("    [SHIP_REGION_INDICATOR_0]   = 0xFF202428u,  // 'off' charge cell")
    w("    [SHIP_REGION_INDICATOR_1]   = 0xFF202428u,")
    w("    [SHIP_REGION_INDICATOR_2]   = 0xFF202428u,")
    w("    [SHIP_REGION_INDICATOR_3]   = 0xFF202428u,")
    w("};")
